...
use App\Repositories\Assessments\AssessmentPIDAdultRepository;

class AssessmentPIDAdultController extends Controller
{
    
    private UserRepository $userRepository;
    private DepartmentRepository $departmentRepository;
    private AssessmentPIDAdultRepository $assPIDAdultRepository;

    public function __construct(UserRepository $userRepository, DepartmentRepository $departmentRepository, AssessmentPIDAdultRepository $assPIDAdultRepository)
    {
        $this->userRepository = $userRepository;
        $this->departmentRepository = $departmentRepository;
        $this->assPIDAdultRepository = $assPIDAdultRepository;
    }
    ...
    public function index()
    {
        ...
        return view('assessment.pid-five-adult.list', compact('collections'));
    }
    ...
    {
        // dd("adult");
        return view('assessment.pid-five-adult.create');
    }
    ...
    public function show($id)
    {
        ...
        // dd($collections);
        return view('assessment.pid-five-adult.reports', compact(
            'collections',
    ...
    {
        // dd("Ok");
        return view('assessment.pid-five-adult.report_list');
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('assessment.pid-five-adult.search')
    ...
    public function pendingList($tool_id)
    {
        ...
        return view('assessment.pid-five-adult.pending_list', compact('appointments'));
    }
}
