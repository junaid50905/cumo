...
class ExecutiveFunctionChecklist extends Component
{
    ...
    public function mount($checklistId = null, $searchId = null)
    {
        ...
        $this->questions = [
            'Questions' => [
                ['id' => 1, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 1, 'question' => 'Have trouble getting started or initiating tasks.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D3.a.05', 'D3.a.04']],
                ['id' => 2, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 2, 'question' => 'Start tasks with enthusiasm but lose interest quickly.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D3.a.03', 'D3.a.04']],
                ['id' => 3, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 3, 'question' => 'Find it hard to do things that are not necessary or highly stimulating.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.b.1' , 'Ind.b.2 ']],
                ['id' => 4, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 4, 'question' => 'I am easily distracted by things I see or hear.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D4.a.2.07']],
                ['id' => 5, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 5, 'question' => 'Become absorbed in things or tasks that interest me—sometimes to the point of forgetting about people around me or other obligations.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D4.a.2.04' , 'D4.a.2.03  ']],
                ['id' => 6, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 6, 'question' => 'Have trouble following conversations because I am distracted or because I am trying to remember what I wanted to say.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D4.a.2.07', 'D4.c.1', 'D4.c.3', 'D4.c.4']],
                ['id' => 7, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 7, 'question' => 'Forget things, even when they are important to me.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D3.a.08', 'D4.a.3']],
                ['id' => 8, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 8, 'question' => 'At least once a day, lose or misplace items—for example, keys, wallet, purse, or cell phone.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['D3.a.01', 'D3.a.03']],
                ['id' => 9, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 9, 'question' => 'Consistently forget appointments and, when I do remember, I often am late.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.a.4', 'D4.a.2.07']],
                ['id' => 10, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 10, 'question' => 'Can’t seem to get a handle on clutter, my personal space is messy and has piles of papers and miscellaneous items.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.a', 'Ind.a.11']],
                ['id' => 11, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 11, 'question' => 'Have difficulty figuring out what is most important or what I should start with given a list of things to do.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.b.1']],
                ['id' => 12, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 12, 'question' => 'Waste time trying to decide what to do first.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.b.1']],
                ['id' => 13, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 13, 'question' => 'Become frustrated when things don’t go as planned and can quickly become angry. I often let go of my anger as quickly as it came.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.b.1']],
                ['id' => 14, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 14, 'question' => 'Have trouble completing multiple-step tasks and moving from one task to another.', 'options' => $this->agreeDisagree, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => ['Ind.b.3' , 'Ind.a']],
                ['id' => 15, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 15, 'question' => 'I say “I will do it later” and then forget all about it.', 'options' => $this->oftenNotOften, 'input_type' => 'radio', 'link_active' => 'yes', 'link_codes' => []],
            ]
