...
class ExecutiveFunctionChecklist extends Component
{
    ...
    public function mount($checklistId = null, $searchId = null)
    {
        ...
        $this->questions = [
            'Questions' => [
                ['id' => 1, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 1, 'question' => 'Have trouble getting started or initiating tasks.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 2, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 2, 'question' => 'Start tasks with enthusiasm but lose interest quickly.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 3, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 3, 'question' => 'Find it hard to do things that are not necessary or highly stimulating.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 4, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 4, 'question' => 'I am easily distracted by things I see or hear.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 5, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 5, 'question' => 'Become absorbed in things or tasks that interest me—sometimes to the point of forgetting about people around me or other obligations.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 6, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 6, 'question' => 'Have trouble following conversations because I am distracted or because I am trying to remember what I wanted to say.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 7, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 7, 'question' => 'Forget things, even when they are important to me.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 8, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 8, 'question' => 'At least once a day, lose or misplace items—for example, keys, wallet, purse, or cell phone.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 9, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 9, 'question' => 'Consistently forget appointments and, when I do remember, I often am late.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 10, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 10, 'question' => 'Can’t seem to get a handle on clutter, my personal space is messy and has piles of papers and miscellaneous items.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 11, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 11, 'question' => 'Have difficulty figuring out what is most important or what I should start with given a list of things to do.', 'options' => $this->agreeDisagree, 'link_codes' => []],
                ['id' => 12, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 12, 'question' => 'Waste time trying to decide what to do first.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 13, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 13, 'question' => 'Become frustrated when things don’t go as planned and can quickly become angry. I often let go of my anger as quickly as it came.', 'options' => $this->oftenNotOften, 'link_codes' => []],
                ['id' => 14, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 14, 'question' => 'Have trouble completing multiple-step tasks and moving from one task to another.', 'options' => $this->agreeDisagree, 'link_codes' => []],
