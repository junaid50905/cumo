    ...
    public function mount($checklistId = null, $searchId = null)
    {
        ...
        $this->questions = [
            'রেফারাল তথ্য' => [
                ...
                ['id' => 2, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 1, 'question' => 'সমন্বয় দক্ষতা আছে কি ?', 'options' => $this->options, 'link_codes' => []],
                ['id' => 3, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 2, 'question' => 'চলাফেরার ক্ষেত্রে ভারসাম্য আছে কি ?', 'options' => $this->options, 'link_codes' => []],
                ['id' => 4, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 3, 'question' => 'সূক্ষ্ম যন্ত্রপাতি ব্যবহার করা সহ ফাইন মটরের দক্ষতা আছে কি ?', 'options' => $this->options, 'link_codes' => []],
                ...
                ['id' => 6, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => '4.1', 'question' => 'আকার, গঠন ঠিক আছে কিনা ', 'options' => $this->options, 'link_codes' => []],
                ['id' => 7, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => '4.2', 'question' => 'আকৃতিঃ ঠিক আছে কিনা ', 'options' => $this->options, 'link_codes' => []],
                ['id' => 8, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => '4.3', 'question' => 'লিখা শেষ করার ধৈর্য : ঠিক আছে কিনা ', 'options' => $this->options, 'link_codes' => []],
                ...
                ['id' => 13, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 9, 'question' => 'empty', 'options' => $this->options, 'link_codes' => []],
                ['id' => 14, 'category_id' => $this->categoryId, 'sub_category_id' => 1, 'question_id' => 10, 'question' => 'empty', 'options' => $this->options, 'link_codes' => []],
