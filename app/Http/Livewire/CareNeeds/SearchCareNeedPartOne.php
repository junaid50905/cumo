...
class SearchCareNeedPartOne extends Component
{
    ...
    public function mount($appointmentId)
    {
        ...
        $introduction = $this->appointmentRepository->getAnAppointmentDetails($this->appointmentId, $incomeType, $eventType, $paymentStatus);
    ...
    public function render()
    {
        ...
        // return view('livewire.care-needs.search-care-need-part-one', $data);
    ...
    private function updateOrCreateData()
    {
        ...
        foreach ($tables as $tableName) {
            ...
            if (isset($this->formData[$collectionName]) && !empty($this->formData[$collectionName])) {
                ...
                $currentTimestamp = now();  // Use Carbon's now() to get the current timestamp
