            ...
            <div class="card-body">
                <div class="field__data">
                    <div class="field__label">
                        <span>Payment Pending Data</span>
                    </div>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        <tr class="table-primary">
                                            ...
                                            <th class="text-center">First_Payment</th>
                                            <th class="text-center">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($allPendingData as $student)
                                        <tr>
                                            ...
                                            <td>{{ $student->is_first_payment !== 1 ? "Pending" : 'Completed' }}</td>
                                            <td class="d-flex align-items-center justify-content-end">
                                                <a href="{{ route('pre-admission-income.payment',  ['id' => $student->id]) }}" wire:navigate
