                                ...
                                <tr class="table-primary">
                                    <td colspan="5" class="text-center fw-bold">
                                        <div>
                                            ...
                                            <p><strong>Max Count Group:</strong> {{ $maxCountGroup['label'] }} (Count: {{ $maxCountGroup['count'] }}, Sum: {{ $maxCountGroup['sum'] }})</p>
                                            <p><strong>Max Sum Group:</strong> {{ $maxSumGroup['label'] }} (Count: {{ $maxSumGroup['count'] }}, Sum: {{ $maxSumGroup['sum'] }})</p>
                                        </div>
                                    </td>
                                </tr>
                            </tfoot>
