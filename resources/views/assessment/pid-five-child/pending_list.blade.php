                                        ...
                                        @foreach ($appointment->event_calendars as $event)
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center justify-content-end">
                                                    <a href="{{ route('assessment-pid-child-search.search', ['search_id' => $appointment->id]) }}"
                                                        rel="noopener noreferrer"
                                                        class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1"
                                                        title="Setup">
                                                        <i class="mdi mdi-cog"></i>
                                                    </a>
                                                    <a href="{{ route('assessment-pid-child.show', $appointment->id) }}"
                                                        rel="noopener noreferrer"
                                                        class="btn btn-sm btn-primary btn-rounded waves-effect waves-light mb-2 me-1"
                                                        title="View">
                        ...
                        <div>
                            <nav aria-label="Page navigation example">
                                <ul class="pagination justify-content-end">
                                    {{ $appointments->links() }} <!-- Add pagination links -->
                                </ul>
                            </nav>
                        </div>
                    </div>
