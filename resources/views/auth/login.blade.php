                                                        ...
                                                        <div class="item">
                                                            <div class="py-3">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <p class="font-size-14 mb-0">- WID User</p>
                                                                </div>
                                                            </div>
                            ...
                            <div class="d-flex flex-column h-100">
                                <div class="mb-4 mb-md-5">
                                    <a href="index" class="d-block auth-logo">
                                        <img src="{{ URL::asset('/assets/images/logo-dark.png') }}" alt="" height="45" class="auth-logo-dark">
                                        <img src="{{ URL::asset('/assets/images/logo-light.png') }}" alt="" height="45" class="auth-logo-light">
                                    </a>
                                </div>
                                <div class="my-auto">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted">Sign in to continue to CUMO.</p>
                                    </div>
                                ...
                                <div class="mt-4 mt-md-5 text-center">
                                    <p class="mb-0">© <script>
                                        ...
                                        </script> Developed <i class="mdi mdi-heart text-danger"></i></p> by aamra Infotainment Limited.
                                </div>
                            </div>
