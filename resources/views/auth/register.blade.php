                                    ...
                                    <div class="mt-4">
                                        <form method="POST" class="form-horizontal" action="{{ route('register') }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <x-input-select name="designation"
                                                    :records="$designations" firstLabel="Select Department"
                                                    :required='true'>
                                                </x-input-select>
                                            </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <x-input-select name="user_type"
                                                    :records="$userTypes" firstLabel="Select User Type"
                                                    :required='true'>
                                                </x-input-select>
                                            </div>
