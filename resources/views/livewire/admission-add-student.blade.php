                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-bs-toggle="tab" href="#case-histroy" role="tab">
                                ...
                                <span class="d-none d-sm-block">Student Add </span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-bs-toggle="tab" href="#case-histroy_list" role="tab">
                                <span class="d-block d-sm-none"><i class="far fa-user"></i></span>
                                <span class="d-none d-sm-block">Student Add List</span>
                            </a>
                        </li>
                    </ul>
                    <!-- Tab panes -->
                        ...
                        <div class="tab-pane active" id="case-histroy" role="tabpanel">
                            <div class="modal-body p-0">
                                <div class="card p-0 m-0">
                                    <div class="card-body">
                                    <p>Route->Controller->Main Blade-> Livewire blade: admission add student blade</p>
                                        <section>
                                            <form wire:submit.prevent="submit" id="AdmissionForm">
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="mb-3 row">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" wire:click="save()" class="btn btn-primary waves-effect waves-light">Save changes</button>
                            </div>
                        </div>
