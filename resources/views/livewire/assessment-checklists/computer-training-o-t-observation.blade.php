                ...
                <div class="card__data__box">
                    <div class="field__data mt-2">
                        <div class="field__label">
                            <span>Computer Training OT Observation Checklist</span>
                        </div>
                        <div class="input__field_data mt-2">
                            ...
                            <div class="content">
                                ...
                                <div id="tabContent" class="tabContent">
                                    ...
                                    @foreach ($questions as $title => $questionGroup)
                                        <div
                                            class="tabPane {{ $currentTabLivewire === $loop->iteration ? 'active' : '' }}">
                                            <div class="card__data__box">
                                                <div class="field__data mt-2">
                                                    <div class="field__label">
                                                        ...
                                                        <form wire:submit.prevent="nextTab">
                                                            <section>
                                                                @foreach ($questionGroup as $question)
                                                                    <x-radio-options-with-code type="radio"
                                                                        wireModel="formData.answers.{{ $question['category_id'] }}_{{ $question['sub_category_id'] }}_{{ $question['id'] }}"
                                                                        label="{{ $question['question'] }}"
                                                                        name="question_{{ $question['id'] }}"
                                                                        :options="$question['options']" :isVertical="true"
                                                                        :linkCodes="$question['link_codes']" :categoryId="$question['category_id']"
                                                                        :subCategoryId="$question['sub_category_id']" :questionId="$question['id']"
                                                                        :questionSerialNo="$question['question_id']" :formData="$formData">
