                ...
                <div class="card__data__box">
                    <div class="field__data mt-2">
                        <div class="field__label">
                            <span>Psychological Assessment Checklist</span>
                        </div>
                                                            ...
                                                            <section>
                                                                ...
                                                                @foreach($questionGroup as $question)
                                                                    <x-radio-options-with-code
                                                                        ...
                                                                        :questionSerialNo="!($question['title'] ?? false) ? $serialNo : null"
                                                                        :formData="$formData"
                                                                        :isVertical="true"
                                                                        :textArea="$question['text_area'] ?? false"
                                                                        :title="$question['title'] ?? false"
                                                                        :linkCodes="$question['link_codes'] ?? []"
                                                                        :linkActive="$question['link_active'] ?? null"
                                                                    />

                                                                    @if(!($question['title'] ?? false))
                                                                        @php $serialNo++; @endphp
                                                                    @endif
                                                                @endforeach
                                                            </section>
