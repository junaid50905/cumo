                    ...
                    <form wire:submit.prevent="submit">
                        ...
                        <div class="field__data mt-2">
                            <div class="field__label">
                                <span>Edit Table of Content Data</span>
                            </div>

                            <div class="input__field_data mt-2">
                                <div class="row">
                                    <p><strong>Data Flow:</strong> {{ $hierarchyString }}</p>
                                </div>
                                <div class="row">
                                            ...
                                            <div class="col-md-10">
                                                <select class="form-control" wire:model="selectedSection" id="section">
                                                    ...
                                                    @foreach($sections as $section)
                                                        <option value="{{ $section->id }}">{{ $section->title }}({{ $section->link_code }})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" wire:model="selectedSubSection" id="sub_section">
                                                        ...
                                                        @foreach($sub_sections as $sub_section)
                                                            <option value="{{ $sub_section->id }}">{{ $sub_section->title }}({{ $sub_section->link_code }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" wire:model="selectedArea" id="area">
                                                        ...
                                                        @foreach($areas as $area)
                                                            <option value="{{ $area->id }}">{{ $area->title }}({{ $area->link_code }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                    ...
                                    @if (!is_null($selectedArea))
                                        <div class="col-12 pb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" wire:model="selectedActivity" id="activity">
                                                        <option value="">-- Select Activity --</option>
                                                        @foreach($activities as $activity)
                                                            <option value="{{ $activity->id }}">{{ $activity->title }}({{ $activity->link_code }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-10">
                                                    <select class="form-control" wire:model="selectedTask" id="task">
                                                        ...
                                                        @foreach($tasks as $task)
                                                            <option value="{{ $task->id }}">{{ $task->title }}({{ $task->link_code }})</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
