                                ...
                                <div class="button__group d-flex gap-2 justify-content-end aligns-items-center"
                                    ...
                                    <div class="d-flex gap-2 justify-content-end aligns-items-center">
                                        ...
                                        <p class="btn btn-primary btn-sm">
                                            {{ $studentData->payment_status !== null ? $studentData->payment_status : 'Pending' }}
                                        </p>
                                    </div>
                                    <div class="d-flex gap-2 justify-content-end aligns-items-center">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <x-input-select name="gender" :records="$gender"
                                                    firstLabel="{{ $studentData->gender !== null ? $studentData->gender : 'Select Gender' }}">
                                                </x-input-select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-8">
                                                <x-input-select name="blood_group" :records="$bloodGroups"
                                                    firstLabel="{{ $studentData->blood_group !== null ? $studentData->blood_group : 'Select Blood Group' }}">
                                                </x-input-select>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="field__data  mt-5">
                        ...
                        <div class="input__field_data">
                            ...
                            <form action="{{route('interviewer-time-setup.interviewer')}}" method="POST">
                                ...
                                <input type="hidden" value="{{ $studentData->student_id }}" name="studentId"
                                    id="studentId">
                                <div class="row">
                                    <div class="col-sm-12 col-md-6 col-lg-6 pb-3 ">
                                        <div class="row">
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 pb-3 ">
                                        <div class="row">
                                            <label for="example-search-input" class="col-md-4 col-form-label">Main
                                                Teacher:</label>
                                            <div class="col-md-8">
                                                <x-input-select-custom name="main_teacher_name" :records="$all_user"
                                    ...
                                    <div class="col-sm-12 col-md-6 col-lg-6 pb-3 ">
                                        <div class="row">
                                            <label for="example-search-input"
                                                class="col-md-4 col-form-label">Assistant:</label>
                                            <div class="col-md-8">
                                                <x-input-select-custom name="assistant_teacher_name"
...
// Initialize current month, year, and date
                ...
                if (events[currentDay]) {
                    events[currentDay].forEach(event => {
                        ...
                        eventElement.innerHTML = `
                            ...
                            <span class="timeFromTo">${formatTime(event.startTime)} to ${formatTime(event.endTime)}</span>
                        `;
