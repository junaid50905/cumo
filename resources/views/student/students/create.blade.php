                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-6">
                                        <div class="mb-3 row">
                                            <label for="example-text-input" class="col-md-4 col-form-label">Student
                                                ID:</label>
                                            <div class="col-md-8">
                                                <x-input-text name="student_id" type="number"
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-tel-input"
                                                class="col-md-4 col-form-label">NID:</label>
                                            <div class="col-md-8">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-password-input"
                                                class="col-md-4 col-form-label">Present
                                                Address:</label>
                                            <div class="col-md-8">
                                    ...
                                    <div class="col-6">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                {{-- <x-input-select name="gender" :selected="$record->gender"
                                                :records="$constants::$genders"></x-input-select> --}}
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                            <label class="col-md-4 col-form-label">Blood Group:</label>
                                            <div class="col-md-8">
                                                {{-- <x-input-select name="blood_group" :selected="$record->blood_group"
                                                :records="$constants::$bloodGroups">
                                            </x-input-select> --}}
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class=" col-md-8">
                                                <x-input-text name="photo" type="file"></x-input-text>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-8">
                                                <div class="mb-3">
                                                    <x-input-select name="stage" :records=$stages /> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 d-flex pb-3">
                                        <div class="mb-3 col-6 d-flex ">
                                            <label for="example-number-input"
                                                ...
                                                Interested in Job: <input class="form-check-input me-5"
                                                    id="container" type="checkbox" name="container"></label>
                                ...
                                <div class="row hide">
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-search-input" class="col-md-4 col-form-label">Local
                                                Guardian:</label>
                                            <div class="col-md-8">
                                                <x-input-text name="local_guardian"
                                                    placeholder="Your local guardian">
                                                </x-input-text>
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-search-input" class="col-md-4 col-form-label">Cause
                                                of
                                                Leave:</label>
                                            <div class="col-md-8">
